...
echo "Добавили расписание бэкапа"
echo "0 */4 * * * /home/sdtdserver/lgsm/config-lgsm/sdtdserver/myrsync.sh" >> /var/spool/cron/sdtdserver
crontab -u sdtdserver /var/spool/cron/sdtdserver
crontab -u sdtdserver -l 
echo "стартанули службу бэкапа"
